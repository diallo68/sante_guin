        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-10">
          ...
          <Section title="3. Partage des données">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 text-sm">
              ...
              <li><strong>Prestataires techniques :</strong> nous utilisons MongoDB Atlas (hébergement base de données) et SendGrid (emails transactionnels) soumis à des obligations de confidentialité strictes.</li>
