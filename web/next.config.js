...
const nextConfig = {
  ...
  // web/ : Next.js détecte les deux et infère la racine du repo comme
  // "workspace root" pour le traçage des fichiers du build standalone —
  // voir audit RA-12. On fixe ici explicitement la même valeur que celle
  // déjà inférée (la racine du repo, pas web/) : ça lève l'avertissement
  // sans changer la structure du build standalone (.next/standalone/web/),
  // dont dépendent web/scripts/deploy-vm.sh et la configuration PM2 de
  // production.
